...
class TTSafeZoneLoader(SafeZoneLoader.SafeZoneLoader):
    ...
    def load(self):
        ...
        try:
            ...
            print("Door trigger not found or errored! Ignoring...")


        try:
            library.find('**/building_front').setY(0.3)
        except:
            print("Building front not found or errored! Ignoring...")

        try:
            library.find('**/front_entrance_flag').setY(0.1)
        except:
            print("Front entrance flag not found or errored! Ignoring...")
