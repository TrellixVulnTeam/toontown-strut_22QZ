...
class DistributedFactoryElevatorExt(DistributedElevatorExt.DistributedElevatorExt):
    ...
    def setEntranceId(self, entranceId):
        ...
        if self.entranceId == 0:
            ...
            self.elevatorModel.setPosHpr(-162.25, -9999, -9999, 269.0, 0.0, 0.0)
        elif self.entranceId == 2:
            #self.elevatorModel.setPosHpr(64.793, -2.34, 0.0, -900.0, 0.0, 0.0)
            self.elevatorModel.setPosHpr(64.793, -9999, -9999, -900.0, 0.0, 0.0)
        else:
            self.notify.warning('Invalid entranceId: %s' % entranceId)
