...
NPCToonDict = {
 ...
 2021: (2000, lnames[2021], ('mss', 'ss', 'm', 'm', 3, 0, 3, 3, 1, 11, 1, 11, 1, 0), 'm', 1, NPC_GLOVE),
...
if config.GetBool('want-new-toonhall', 1):
    NPCToonDict[2001] = (2513, lnames[2001], ('mss', 'ss', 'l', 'm', 3, 0, 3, 20, 3, 11, 1, 11, 1, 2), 'm', 1, NPC_FLIPPYTOONHALL)
else:
    NPCToonDict[2001] = (2513, lnames[2001], ('mss', 'ss', 'l', 'm', 3, 0, 3, 20, 3, 11, 1, 11, 1, 2), 'm', 1, NPC_REGULAR)
# 11, 1, 11, 1, 0
